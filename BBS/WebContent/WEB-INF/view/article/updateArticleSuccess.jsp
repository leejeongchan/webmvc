...
<section class="container mt-3" style="max-width: 560px;">
		...
		<h1 class="h3 mt-2 text-center">게시글을 수정완료했습니다.${ctxPath = pageContext.request.contextPath ; ''}</h1>
		<div class="text-center">
		<a class="btn btn-primary mt-2 text-center" href="/article/list.do">게시글목록보기</a>
		</div>
		<!-- <a class="btn btn-primary" href="/article/read.do?bdSeq=${result.bdSeq}">게시글내용보기</a> -->
