...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div id="navbar" class="collapse navbar-collapse">
			...
			<form method="post" action="/article/searchlist.do" class="form-inline mt-3">
							<select name="searchOption" class="form-control mx-1 mt-2">
								<option value="subject">제목</option>
								<option value="writer">작성자</option>
								<option value="recommandcount">추천순서</option>
								<option value="readcount">조회수</option>
							</select> 
							<input type="text" name="searchWord" class="form-control mx-1 mt-2"
...
<c:forEach var="articleList" items="${articleList}">
	...
	<tr>
		...
		<td>${articleList.replyCnt}</td>
	</tr>
	</tbody>
</c:forEach>
</table>
-->
<a class="btn btn-primary mt-3" href="write.do">게시글쓰기</a>
<hr>
  <%-- 페이징 영역 시작 --%>
