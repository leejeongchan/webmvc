...
public class PagingMo {
	...
	public String getPagingPrint(int total,int curPage,int rowSize,int blockSize,String pageName) {
		...
		try {
			...
			result.append("<li class='page-item'><a class='pagingPrev page-link' href ='javascript:" + pageName + "(" );
			...
			for(int i = startPage ; i<=endPage ; i++) {
				if(i== curPage) {
					result.append("<li class='page-item'><a class='currentPage page-link' href='javascript:" + pageName + "(");
				}else {
					result.append("<li class='page-item'><a class='page-link' href='javascript:" + pageName + "(");
				}
				result.append(i);
				result.append(")'>");
				result.append(i);
			...
			//afterPage			
			result.append("<li class='page-item'><a class='pagingNext page-link' href='javascript:" + pageName + "(");
